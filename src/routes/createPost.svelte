...
<!-- <section class="container mx-auto p-8">
	...
	<div class="my-4">
		{#if isAlertActive && !isSuccessAlert}
			<div
				class="flex p-4 mb-4 text-md text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800"
				role="alert"
			>
				<svg
		...
		{:else if isAlertActive && isSuccessAlert}
			<div
				class="flex p-4 mb-4 text-md text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800"
				role="alert"
			>
				<svg
					class="inline flex-shrink-0 mr-3 w-5 h-5"
